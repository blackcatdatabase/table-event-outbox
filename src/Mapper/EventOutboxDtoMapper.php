...
namespace BlackCat\Database\Packages\EventOutbox\Mapper;

use BlackCat\Database\Packages\EventOutbox\Dto\EventOutboxDto;
use BlackCat\Database\Packages\EventOutbox\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO EventOutboxDto:
 ...
 */
final class EventOutboxDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'id' => 'id', 'event_key' => 'eventKey', 'entity_table' => 'entityTable', 'entity_pk' => 'entityPk', 'event_type' => 'eventType', 'payload' => 'payload', 'status' => 'status', 'attempts' => 'attempts', 'next_attempt_at' => 'nextAttemptAt', 'processed_at' => 'processedAt', 'producer_node' => 'producerNode', 'created_at' => 'createdAt' ];
    ...
    /** @var string[] */
    private const DATE_COLS   = [ 'next_attempt_at', 'processed_at', 'created_at' ];
    /** @var string[] */
     ...
     */
    public static function fromRow(array $row): EventOutboxDto
    {
        /** @var EventOutboxDto */
        return DtoHydrator::fromRow(
            EventOutboxDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?EventOutboxDto
    {
     ...
     *
     * @param EventOutboxDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(EventOutboxDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(EventOutboxDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(EventOutboxDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,EventOutboxDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,EventOutboxDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(EventOutboxDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,EventOutboxDto>
     */
