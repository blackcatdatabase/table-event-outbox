...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'event_key', 'entity_table', 'entity_pk', 'event_type', 'payload', 'status', 'attempts', 'next_attempt_at', 'processed_at', 'producer_node', 'created_at' ];
    }
    ...
    {
        $x = [ 'id', 'event_key', 'entity_table', 'entity_pk', 'event_type', 'status', 'attempts', 'next_attempt_at', 'processed_at', 'producer_node', 'created_at' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\EventOutbox\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\EventOutbox\Definitions::softDeleteColumn();
