...
> Lineage: 0 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 3 · Changelog: fresh (18 d)
...
| Pkg folder | [packages\event-outbox](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\event-outbox) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package event-outbox -Apply
